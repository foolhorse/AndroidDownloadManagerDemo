...
public class DownloadReceiver extends BroadcastReceiver {
	...
	private void openDownload(Context context, Cursor cursor) {
		...
		String mimetype = cursor
				.getString(cursor.getColumnIndexOrThrow(Downloads.COLUMN_MIME_TYPE));
	...
	private void sendNotificationClickedIntent(Intent intent, Cursor cursor) {
		String pckg = cursor.getString(cursor
				.getColumnIndexOrThrow(Downloads.COLUMN_NOTIFICATION_PACKAGE));
		if (pckg == null) {
			return;
		}

		String clazz = cursor.getString(cursor
				.getColumnIndexOrThrow(Downloads.COLUMN_NOTIFICATION_CLASS));
